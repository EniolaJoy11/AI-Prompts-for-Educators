...
A collection of practical AI prompts designed to help educators save time, improve lesson planning, create resources, and streamline classroom tasks.

This contains a growing collection of **AI prompts designed to support educators** in lesson planning, assessment creation, student feedback, and classroom management.
These prompts are created to **save time**, **improve productivity**, and **enhance teaching efficiency** using AI tools.


Educators spend many hours planning lessons, writing reports, and creating resources.
This project provides **ready-to-use prompts** that make these tasks faster and easier.

## Lesson Planning Prompts

### Prompt 1 — Generate a Lesson Plan

Create a detailed lesson plan for **[Subject]** for **[Year Group]** students.
Include:
...
### Prompt 2 — Create Weekly Lesson Plans

Generate a **5-day weekly lesson plan** for **[Subject]** for **[Year Group]** students.
Ensure lessons build progressively throughout the week.


### Prompt 3 — Differentiate a Lesson

Modify this lesson plan to include:
...
| **Introduction (Teacher Input)** |                        |                        |
| **Guided Practice**              |                        |                        |
| **Independent Practice**         |                        |                        |
| **Assessment**                   |                        |                        |
| **Plenary (Lesson Closure)**     |                        |                        |
...
Create **10 practice questions** on **[Topic]** suitable for **[Year Group]** students.
...
### Prompt 5 — Generate Word Problems

Create **5 real-life word problems** on **[Topic]** for **[Year Group]** students.


### Prompt 6 — Create Spelling Worksheets

Generate a spelling worksheet using these words:
...
### **Section B: Fill in the Missing Letters**

Complete the spelling words.

| **No.** | **Word with Missing Letters** |
| ------- | ----------------------------- |
| 1       | _ _ _ _ _                    |
| 2       | _ _ _ _ _                     |
| 3       | _ _ _ _ _                     |
...
### **Section C: Write the Correct Spelling**

Write each word **two times**.

| **Word** | **Write 1** | **Write 2** |
| -------- | ----------- | ----------- |
| 1        |             |             |
| 2        |             |             |
| 3        |             |             |
...
### **Section D: Fill in the Blanks (Use the Correct Word)**

| **Sentence**                                 | **Answer** |
| -------------------------------------------- | ---------- |
| 1. I sat at the ______.                      |            |
| 2. The book is on the ______.                |            |
| 3. Please clean the ______.                  |            |
| 4. We ate dinner at the ______.              |            |
| 5. The teacher placed the pen on the ______. |            |

*(You can change sentences based on your spelling words.)*

---

### **Section E: Sentence Writing**
...
### **Section F: Word Search / Challenge (Optional)**

| **Challenge Activity**                           |
| ------------------------------------------------ |
| Write your spelling words in alphabetical order. |
| OR                                               |
| Circle all the vowels in each word.              |



### Prompt 7 — Create an Assessment

Create an assessment for **[Subject]** on **[Topic]** for **[Year Group]** students.
...
### Prompt 8 — Generate a Marking Rubric

Create a marking rubric for **[Assignment Type]** for **[Year Group]** students.
...
### Prompt 9 — Write Parent Feedback

Write a professional feedback message to parents about a student's progress.
...
Generate **3 positive report comments** for a student who:
...
Write constructive feedback for a student struggling with:
...
Create a reflection sheet for students who misbehave.
...
## AI Tools You Can Use With These Prompts

You can use these prompts with tools like:
